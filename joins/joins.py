...
class Joins(Scene):
    def construct(self):
        ...
        self.play(FadeIn(title.to_corner(LEFT + UP), left_circle, description.to_edge(RIGHT, 0.8)))
        ...
        self.play(FadeTransform(left_2, left_3), FadeTransform(right_2, right_3), run_time = 1.5)
        ...
        self.play(FadeOut(title, left_4))

        self.wait(1)
        
        self.next_section("LeftJoin")
        ...
        self.play(right_circle.animate.move_to(LEFT * 2).set_fill(opacity = 0.8), left_circle.animate.move_to(LEFT * 4), run_time = 2)
        ...
        self.play(FadeTransform(right_2, right_3), run_time = 1)
        ...
        self.play(FadeOut(title, left_3))
        
        self.wait(1)

        self.next_section("OuterJoin")
        ...
        final = Table(
            ...
            include_background_rectangle=False,
            background_rectangle_color = joins_palette_hex["molten"],
            line_config={"color": joins_palette_hex["aurora"], "stroke_width": 7}).scale(0.7)
        ...
        self.play(TransformMatchingShapes(left_2, final), TransformMatchingShapes(right_2, final), run_time = 1)
